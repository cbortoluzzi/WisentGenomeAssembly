...
# Run GALBA using the protein sequences of Bos taurus, Ovis aries, and Capra hircus, but using the pre-computed parameters of human
echo -e "Run GALBA ... this might take a few days\n\n"
perl /cluster/work/pausch/cbortoluzzi/softwares/GALBA-1.0.7/scripts/galba.pl --species=human --genome=/cluster/work/pausch/cbortoluzzi/wisent_project/repeat_annotation/Bison_bonasus/RepeatMasker/WISENTM_Urano_F1.hap1.rm.unmasked.fasta.masked --prot_seq=/cluster/work/pausch/cbortoluzzi/wisent_project/annotation/proteins.fa --threads=4 --workingdir=/cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3 --skipAllTraining

# Reducing noise in augustus.hints.gtf with TSEBRA
echo -e "Reduce noise with TSEBRA\n\n"
python3 /cluster/work/pausch/cbortoluzzi/softwares/TSEBRA-v.1.1.1/bin/tsebra.py -g /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/augustus.hints.gff -e /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/hintsfile.gff -o /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/galba.gtf > /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/tsebra.log 2> /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/errors/tsebra.err
python3 /cluster/work/pausch/cbortoluzzi/softwares/Augustus-3.5.0/scripts/getAnnoFastaFromJoingenes.py -g /cluster/work/pausch/cbortoluzzi/wisent_project/repeat_annotation/Bison_bonasus/RepeatMasker/WISENTM_Urano_F1.hap1.rm.unmasked.fasta.masked -f /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/galba.gtf -o /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/galba 1>/cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/getAnnoFastaFromJoingenes.tsebra.stdout 2> /cluster/work/pausch/cbortoluzzi/wisent_project/annotation/WISENTM_Urano_F1_hap1/run_3/errors/getAnnoFastaFromJoingenes.tsebra.stderr

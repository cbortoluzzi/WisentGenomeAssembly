...
if [ $# -ne 1 ]
then
	echo -e "\nusage: `basename $0` <reference-genome.fasta> <output directory>\n"
	...
	echo -e "REQUIRES:  Installation of RepeatModeler (v2.0.4), samtools (v1.15.1) and Genometools (v1.6.2) accessible from PATH\n\n"
